...
Expected project layout:
- metadata/splits/train.csv, val.csv (80-20 split)
- metadata/encoders/onehot_encoder.pkl and scaler.pkl
- src/data_loader.py exists and creates `train_ds`, `val_ds`
"""
...
# 6) Save final model
final_saved = MODELS_DIR / "final_model.keras"
model.save(str(final_saved), include_optimizer=False)
print(f"\n✅ Model saved to: {final_saved}")
